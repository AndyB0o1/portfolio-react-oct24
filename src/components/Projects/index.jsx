export default function Projects() {
    ...
    return (
        <div>
            <div className="p-2 m-1 bg-black font-mono text-white" onClick={showProjects}>
                <div>
                    <p className="text-xl text-green-600">Projects</p>
                    <div className="projectText">
                        ...
                        <div className="p-1.5 text-pink-500">
                            <p><span>$projects</span><span className="text-white"> = </span><span>$this</span><span className="text-white">{arrow1}</span><span>project</span><span className="text-white">{arrow1}</span>
                                <span className="text-sky-500">get</span><span className="text-white">{brackets};</span></p>
                        </div>
                        <div className="p-2 bg-black font-mono text-green-600">
            ...
            <div className="projects hidden flex flex-wrap justify-around mx-auto gap-2 p-2 bg-white font-mono text-black">
                <div className="mb-2 p-2 border rounded-lg basis-2/5 font-mono">
                    <h3 className="font-bold">Using Laravel to build a RESTful API for a book swap site</h3>
                    <div className="w-full h-72 mb-2 content-center">
                        <img src="src/assets/laravel-book-swap.png" className="h-72 mx-auto" />
                    </div>
                ...
                <div className="mb-2 p-2 border rounded-lg basis-2/5 font-mono">
                    ...
                    <div className="w-full h-72 mb-2 content-center">
                        <img src="src/assets/React.png" className="w-full mx-auto" />
                    </div>
                ...
                <div className="mb-2 p-2 border rounded-lg basis-2/5 font-mono">
                    <h3 className="mb-5 font-bold">Using PHP, MySQL, Object-Oriented Programming</h3>
                    <div className="w-full h-72 mb-2 content-center">
                        <img src="src/assets/OOP.png" className="w-full mx-auto" />
                    </div>
                ...
                <div className="mb-2 p-2 border rounded-lg basis-2/5 font-mono">
                    ...
                    <div className="w-full h-72 mb-2">
                        <img src="src/assets/weather-forecast.png" className="h-full mx-auto" />
                    </div>
