    ...
    return (
        <div className="p-2 m-1 bg-black font-mono text-yellow-300">
            ...
            <p className="text-xs sm:text-base"><a href="mailto:andybooldev@gmail.com" className="hover:text-pink-500">Email</a>&nbsp; | &nbsp;
                ...
                <a href="/Andy Bool CV Oct 24.pdf" download className="sm:hidden hover:text-pink-500">CV</a>
                <a href="/Andy Bool CV Oct 24.pdf" download className="hidden sm:inline hover:text-pink-500">Download my CV</a>
            </p>
        </div>
    )
}